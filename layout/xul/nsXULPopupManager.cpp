...
static_assert(bindings::KeyboardEvent::DOM_VK_HOME  ==
                bindings::KeyboardEvent::DOM_VK_END + 1 &&
              bindings::KeyboardEvent::DOM_VK_LEFT  ==
                bindings::KeyboardEvent::DOM_VK_END + 2 &&
              bindings::KeyboardEvent::DOM_VK_UP    ==
                bindings::KeyboardEvent::DOM_VK_END + 3 &&
              bindings::KeyboardEvent::DOM_VK_RIGHT ==
                bindings::KeyboardEvent::DOM_VK_END + 4 &&
              bindings::KeyboardEvent::DOM_VK_DOWN  ==
                bindings::KeyboardEvent::DOM_VK_END + 5,
              "nsXULPopupManager assumes some keyCode values are consecutive");

const nsNavigationDirection DirectionFromKeyCodeTable[2][6] = {
  {
    eNavigationDirection_Last,   // bindings::KeyboardEvent::DOM_VK_END
    eNavigationDirection_First,  // bindings::KeyboardEvent::DOM_VK_HOME
    eNavigationDirection_Start,  // bindings::KeyboardEvent::DOM_VK_LEFT
    eNavigationDirection_Before, // bindings::KeyboardEvent::DOM_VK_UP
    eNavigationDirection_End,    // bindings::KeyboardEvent::DOM_VK_RIGHT
    eNavigationDirection_After   // bindings::KeyboardEvent::DOM_VK_DOWN
  },
  {
    eNavigationDirection_Last,   // bindings::KeyboardEvent::DOM_VK_END
    eNavigationDirection_First,  // bindings::KeyboardEvent::DOM_VK_HOME
    eNavigationDirection_End,    // bindings::KeyboardEvent::DOM_VK_LEFT
    eNavigationDirection_Before, // bindings::KeyboardEvent::DOM_VK_UP
    eNavigationDirection_Start,  // bindings::KeyboardEvent::DOM_VK_RIGHT
    eNavigationDirection_After   // bindings::KeyboardEvent::DOM_VK_DOWN
  }
};
...
nsXULPopupManager::HandleKeyboardNavigation(uint32_t aKeyCode)
{
  ...
  NS_ASSERTION(aKeyCode >= bindings::KeyboardEvent::DOM_VK_END &&
                 aKeyCode <= bindings::KeyboardEvent::DOM_VK_DOWN, "Illegal key code");
                        ...
                        nsMenuChainItem* aTopVisibleMenuItem)
{
  ...
  if (aTopVisibleMenuItem &&
    ...
    if (keyCode == bindings::KeyboardEvent::DOM_VK_ESCAPE) {
  ...
  switch (keyCode) {
    ...
    case bindings::KeyboardEvent::DOM_VK_PAGE_UP:
      if (aTopVisibleMenuItem) {
        aTopVisibleMenuItem->Frame()->ChangeByPage(
          keyCode == bindings::KeyboardEvent::DOM_VK_PAGE_UP);
      }
      break;

    case bindings::KeyboardEvent::DOM_VK_ESCAPE:
    ...
    case bindings::KeyboardEvent::DOM_VK_TAB:
#ifndef XP_MACOSX
    case bindings::KeyboardEvent::DOM_VK_F10:
#endif
      if (aTopVisibleMenuItem &&
    ...
    case bindings::KeyboardEvent::DOM_VK_RETURN: {
...
nsXULPopupManager::KeyDown(KeyboardEvent* aKeyEvent)
{
  ...
  if (menuAccessKey) {
    ...
    if (theChar == (uint32_t)menuAccessKey) {
      bool ctrl = (menuAccessKey != bindings::KeyboardEvent::DOM_VK_CONTROL &&
                   aKeyEvent->CtrlKey());
      bool alt = (menuAccessKey != bindings::KeyboardEvent::DOM_VK_ALT &&
                  aKeyEvent->AltKey());
      bool shift = (menuAccessKey != bindings::KeyboardEvent::DOM_VK_SHIFT &&
                    aKeyEvent->ShiftKey());
      bool meta = (menuAccessKey != bindings::KeyboardEvent::DOM_VK_META &&
                   aKeyEvent->MetaKey());
