...
SharedSurfaceTextureData::SharedSurfaceTextureData(
    const SurfaceDescriptor& desc, const gfx::SurfaceFormat format, const gfx::IntSize size)
...
SharedSurfaceTextureClient::SharedSurfaceTextureClient(
    ...
    : TextureClient(new SharedSurfaceTextureData(desc), FlagsFrom(desc), aAllocator) {
