...
TextureType PreferredCanvasTextureType(const KnowsCompositor& aKnowsCompositor) {
  ...
  return GetTextureType(gfx::SurfaceFormat::R8G8B8A8, {1,1}, layersBackend, moz2DBackend,
                        2, TextureAllocationFlags::ALLOC_DEFAULT);
}
