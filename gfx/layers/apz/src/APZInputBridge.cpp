...
{
  if (!(aEvent->mDeltaMode == dom::bindings::WheelEvent::DOM_DELTA_LINE ||
        aEvent->mDeltaMode == dom::bindings::WheelEvent::DOM_DELTA_PIXEL ||
        aEvent->mDeltaMode == dom::bindings::WheelEvent::DOM_DELTA_PAGE)) {
    return Nothing();
  }
    ...
    case eWheelEventClass: {
      ...
      if (Maybe<APZWheelAction> action = ActionForWheelEvent(&wheelEvent)) {
        ...
        if (gfxPrefs::SmoothScrollEnabled() &&
            ((wheelEvent.mDeltaMode == dom::bindings::WheelEvent::DOM_DELTA_LINE &&
              gfxPrefs::WheelSmoothScrollEnabled()) ||
             (wheelEvent.mDeltaMode == dom::bindings::WheelEvent::DOM_DELTA_PAGE &&
