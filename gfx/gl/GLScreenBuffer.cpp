...
SwapChainPresenter::SwapChainPresenter(SwapChain& swapChain) : mSwapChain(&swapChain) {
...
UniquePtr<SharedSurface> SwapChainPresenter::SwapBackBuffer(UniquePtr<SharedSurface> back) {
  if (mBackBuffer) {
