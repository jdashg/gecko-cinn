...
class SharedSurface_D3D11Interop final : public SharedSurface {
 ...
 private:
  SharedSurface_D3D11Interop(const SharedSurfaceDesc&, UniquePtr<MozFramebuffer>&& fbForDrawing, Data&&);
...
class SurfaceFactory_D3D11Interop : public SurfaceFactory {
 ...
 protected:
  UniquePtr<SharedSurface> CreateSharedImpl(const SharedSurfaceDesc& desc) override {
