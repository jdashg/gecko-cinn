...
class SharedSurface_EGLImage final : public SharedSurface {
 ...
 protected:
  SharedSurface_EGLImage(const SharedSurfaceDesc&, UniquePtr<MozFramebuffer>&& fb, EGLImage);
...
class SharedSurface_SurfaceTexture final : public SharedSurface {
 ...
 public:
  static UniquePtr<SharedSurface_SurfaceTexture> Create(const SharedSurfaceDesc&);
