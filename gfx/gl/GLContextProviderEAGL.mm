...
GLContextEAGL::GLContextEAGL(const GLContextDesc& desc,
...
already_AddRefed<GLContext> GLContextProviderEAGL::CreateHeadless(const GLContextCreateDesc& createDesc,
