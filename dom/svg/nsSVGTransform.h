...
public:
  ...
  nsSVGTransform()
    ...
    , mOriginX(0.f)
    , mOriginY(0.f)
    , mType(dom::bindings::SVGTransform::SVG_TRANSFORM_MATRIX)
  { }
...
public:
  ...
  {
    MOZ_ASSERT(aType >=dom::bindings::SVGTransform:: SVG_TRANSFORM_MATRIX &&
               aType <= dom::bindings::SVGTransform::SVG_TRANSFORM_SKEWY,
  ...
  : mTransformType(aType)
  {
    MOZ_ASSERT(aType >= dom::bindings::SVGTransform::SVG_TRANSFORM_TRANSLATE &&
               aType <= dom::bindings::SVGTransform::SVG_TRANSFORM_SKEWY,
