...
{
  if (unit > bindings::SVGLength::SVG_LENGTHTYPE_UNKNOWN &&
      unit <= bindings::SVGLength::SVG_LENGTHTYPE_PC)
    return true;
                                 ...
                                 bool& aPreventCachingOfSandwich) const
{
  ...
  aPreventCachingOfSandwich =
              (unitType == bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE ||
               unitType == bindings::SVGLength::SVG_LENGTHTYPE_EMS ||
               unitType == bindings::SVGLength::SVG_LENGTHTYPE_EXS);
