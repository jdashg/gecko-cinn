...
{
  return bindings::SVGLinearGradientElement::Wrap(aCx, this, aGivenProto);
}

nsSVGElement::LengthInfo SVGLinearGradientElement::sLengthInfo[4] =
{
  { &nsGkAtoms::x1, 0, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::X },
  { &nsGkAtoms::y1, 0, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::Y },
  { &nsGkAtoms::x2, 100, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::X },
  { &nsGkAtoms::y2, 0, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::Y },
};
...
{
  return bindings::SVGRadialGradientElement::Wrap(aCx, this, aGivenProto);
}

nsSVGElement::LengthInfo SVGRadialGradientElement::sLengthInfo[6] =
{
  { &nsGkAtoms::cx, 50, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::X },
  { &nsGkAtoms::cy, 50, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::Y },
  { &nsGkAtoms::r, 50, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::XY },
  { &nsGkAtoms::fx, 50, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::X },
  { &nsGkAtoms::fy, 50, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::Y },
  { &nsGkAtoms::fr, 0, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::XY },
};
