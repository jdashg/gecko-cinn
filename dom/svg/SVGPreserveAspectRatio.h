...
const uint16_t SVG_ALIGN_MIN_VALID =
  dom::bindings::SVGPreserveAspectRatio::SVG_PRESERVEASPECTRATIO_NONE;
const uint16_t SVG_ALIGN_MAX_VALID =
  dom::bindings::SVGPreserveAspectRatio::SVG_PRESERVEASPECTRATIO_XMAXYMAX;
...
const uint16_t SVG_MEETORSLICE_MIN_VALID =
  dom::bindings::SVGPreserveAspectRatio::SVG_MEETORSLICE_MEET;
const uint16_t SVG_MEETORSLICE_MAX_VALID =
  dom::bindings::SVGPreserveAspectRatio::SVG_MEETORSLICE_SLICE;
...
public:
  explicit SVGPreserveAspectRatio()
    : mAlign(dom::bindings::SVGPreserveAspectRatio::SVG_PRESERVEASPECTRATIO_UNKNOWN)
    , mMeetOrSlice(dom::bindings::SVGPreserveAspectRatio::SVG_MEETORSLICE_UNKNOWN)
  {}
