...
{
  { &nsGkAtoms::x, 0, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::X },
  { &nsGkAtoms::y, 0, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::Y },
  { &nsGkAtoms::width, 100, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::X },
  { &nsGkAtoms::height, 100, bindings::SVGLength::SVG_LENGTHTYPE_PERCENTAGE, SVGContentUtils::Y }
};
...
{
  return bindings::SVGFEFuncRElement::Wrap(aCx, this, aGivenProto);
}
...
{
  return bindings::SVGFEFuncGElement::Wrap(aCx, this, aGivenProto);
}
...
{
  return bindings::SVGFEFuncBElement::Wrap(aCx, this, aGivenProto);
}
...
{
  return bindings::SVGFEFuncAElement::Wrap(aCx, this, aGivenProto);
}
