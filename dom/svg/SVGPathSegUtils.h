...
#define NS_SVG_PATH_SEG_FIRST_VALID_TYPE dom::bindings::SVGPathSeg::PATHSEG_CLOSEPATH
#define NS_SVG_PATH_SEG_LAST_VALID_TYPE  dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL
...
public:
  ...
  static bool IsCubicType(uint32_t aType) {
    return aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_REL ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_ABS ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_SMOOTH_REL ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_SMOOTH_ABS;
  }

  static bool IsQuadraticType(uint32_t aType) {
    return aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_REL ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_ABS ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_SMOOTH_ABS;
  }

  static bool IsArcType(uint32_t aType) {
    return aType == dom::bindings::SVGPathSeg::PATHSEG_ARC_ABS ||
           aType == dom::bindings::SVGPathSeg::PATHSEG_ARC_REL;
  }
  ...
  static bool IsRelativeOrAbsoluteType(uint32_t aType) {
    ...
    static_assert(NS_SVG_PATH_SEG_LAST_VALID_TYPE ==
                    dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL,
                  "Unexpected type");

    return aType >= dom::bindings::SVGPathSeg::PATHSEG_MOVETO_ABS;
  }
