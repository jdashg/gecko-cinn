...
#define CHECK_ARG_COUNT_IN_SYNC(segType)                                      \
  MOZ_ASSERT(ArrayLength(mArgs) ==                                            \
             ...
             uint32_t(segType) == dom::bindings::SVGPathSeg::PATHSEG_CLOSEPATH,  \
...
#define IMPL_SVGPATHSEG_SUBCLASS_COMMON(segName, segType)                     \
  ...
  {                                                                           \
    return dom::bindings::SVGPathSeg##segName::Wrap(aCx, this, aGivenProto);   \
  }
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    ClosePath, dom::bindings::SVGPathSeg::PATHSEG_CLOSEPATH)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    MovetoAbs, dom::bindings::SVGPathSeg::PATHSEG_MOVETO_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    MovetoRel, dom::bindings::SVGPathSeg::PATHSEG_MOVETO_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    LinetoAbs, dom::bindings::SVGPathSeg::PATHSEG_LINETO_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    LinetoRel, dom::bindings::SVGPathSeg::PATHSEG_LINETO_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoCubicAbs, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoCubicRel, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoQuadraticAbs, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoQuadraticRel, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    ArcAbs, dom::bindings::SVGPathSeg::PATHSEG_ARC_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    ArcRel, dom::bindings::SVGPathSeg::PATHSEG_ARC_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    LinetoHorizontalAbs, dom::bindings::SVGPathSeg::PATHSEG_LINETO_HORIZONTAL_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    LinetoHorizontalRel, dom::bindings::SVGPathSeg::PATHSEG_LINETO_HORIZONTAL_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    LinetoVerticalAbs, dom::bindings::SVGPathSeg::PATHSEG_LINETO_VERTICAL_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    LinetoVerticalRel, dom::bindings::SVGPathSeg::PATHSEG_LINETO_VERTICAL_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoCubicSmoothAbs, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_SMOOTH_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoCubicSmoothRel, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_CUBIC_SMOOTH_REL)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoQuadraticSmoothAbs, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_SMOOTH_ABS)
...
public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(
    CurvetoQuadraticSmoothRel, dom::bindings::SVGPathSeg::PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL)
