...
public:
  nsSVGOrientType()
   : mAnimVal(bindings::SVGMarkerElement::SVG_MARKER_ORIENT_ANGLE),
     mBaseVal(bindings::SVGMarkerElement::SVG_MARKER_ORIENT_ANGLE) {}
  ...
  uint16_t GetBaseValue() const
    { return mAnimVal == SVG_MARKER_ORIENT_AUTO_START_REVERSE ?
               bindings::SVGMarkerElement::SVG_MARKER_ORIENT_UNKNOWN : mBaseVal; }
  uint16_t GetAnimValue() const
    { return mAnimVal == SVG_MARKER_ORIENT_AUTO_START_REVERSE ?
               bindings::SVGMarkerElement::SVG_MARKER_ORIENT_UNKNOWN : mAnimVal; }
