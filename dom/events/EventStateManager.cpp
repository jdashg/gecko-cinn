  ...
  if (IsTrackingDragGesture()) {
    ...
    if (IsEventOutsideDragThreshold(aEvent)) {
      ...
      if (aEvent->AsMouseEvent()) {
        ...
        startEvent.inputSource = bindings::MouseEvent::MOZ_SOURCE_TOUCH;
      } else {
        MOZ_ASSERT(false);
      }
    ...
    case bindings::WheelEvent::DOM_DELTA_PAGE:
      scrollDeltaX =
        !aEvent->mLineOrPageDeltaX ? 0 :
          (aEvent->mLineOrPageDeltaX > 0  ? bindings::UIEvent::SCROLL_PAGE_DOWN :
                                            bindings::UIEvent::SCROLL_PAGE_UP);
      scrollDeltaY =
        !aEvent->mLineOrPageDeltaY ? 0 :
          (aEvent->mLineOrPageDeltaY > 0  ? bindings::UIEvent::SCROLL_PAGE_DOWN :
                                            bindings::UIEvent::SCROLL_PAGE_UP);
                                   ...
                                   nsIScrollableFrame* aScrollableFrame)
{
  ...
  bool isPage = (aEvent->mDeltaMode == bindings::WheelEvent::DOM_DELTA_PAGE);
  if (aScrollableFrame) {
                                ...
                                WidgetWheelEvent* aEvent)
{
  ...
  bool isDeltaModePixel =
    (aEvent->mDeltaMode == bindings::WheelEvent::DOM_DELTA_PIXEL);
                                   ...
                                   nsIContent* aOverrideClickTarget)
{
      ...
      if (nsEventStatus_eConsumeNoDefault != *aStatus &&
        ...
        if (fm) {
          ...
          if (newFocus) {
            ...
            if (mouseEvent->inputSource == bindings::MouseEvent::MOZ_SOURCE_TOUCH) {
  ...
  case ePointerUp: {
    ...
    if (pointerEvent->mMessage == ePointerCancel ||
        pointerEvent->inputSource == bindings::MouseEvent::MOZ_SOURCE_TOUCH) {
                                       ...
                                       WidgetWheelEvent* aEvent)
{
  ...
  if (mHandlingDeltaMode == bindings::WheelEvent::DOM_DELTA_PIXEL) {
