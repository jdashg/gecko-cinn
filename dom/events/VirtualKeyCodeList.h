 ...
 * aDOMKeyCode is one of mozilla::dom::bindings::KeyboardEvent::DOM_VK_*.
 *
...
#define DEFINE_VK_INTERNAL(aKeyName) \
  NS_DEFINE_VK(VK##aKeyName, mozilla::dom::bindings::KeyboardEvent::DOM_VK##aKeyName)

// Some keycode may have different name in KeyboardEvent from its key name.
#define DEFINE_VK_INTERNAL2(aKeyName, aKeyCodeName) \
  NS_DEFINE_VK(VK##aKeyName, mozilla::dom::bindings::KeyboardEvent::DOM_VK##aKeyCodeName)
