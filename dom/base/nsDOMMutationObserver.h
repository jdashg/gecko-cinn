...
public:
  ...
  {
    return mozilla::dom::bindings::MutationRecord::Wrap(aCx, this, aGivenProto);
  }
...
public:
                                          ...
                                          nsAtom* aAttribute) override
  {
    ...
    AttributeWillChange(aElement, aNameSpaceID, aAttribute,
                        mozilla::dom::bindings::MutationEvent::MODIFICATION, nullptr);
  }
...
public:
  ...
  virtual JSObject* WrapObject(JSContext* aCx, JS::Handle<JSObject*> aGivenProto) override
  {
    return mozilla::dom::bindings::MutationObserver::Wrap(aCx, this, aGivenProto);
  }
