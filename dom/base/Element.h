...
public:
   ...
   * @param aModType [out] Set to bindings::MutationEvent::MODIFICATION or to
   *   bindings::MutationEvent::ADDITION, but only if this helper returns true
...
protected:
   ...
   * @param aModType      bindings::MutationEvent::MODIFICATION or ADDITION.  Only
