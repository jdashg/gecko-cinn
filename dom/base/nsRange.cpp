...
{
  return bindings::Range::Wrap(aCx, this, aGivenProto);
}
                               ...
                               ErrorResult& rv)
{
  ...
  switch (aHow) {
    case bindings::Range::START_TO_START:
