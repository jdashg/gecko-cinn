...
public:
  ...
  {
    return mozilla::dom::bindings::IntersectionObserverEntry::Wrap(aCx, this, aGivenProto);
  }
...
public:
  ...
  virtual JSObject* WrapObject(JSContext* aCx, JS::Handle<JSObject*> aGivenProto) override
  {
    return mozilla::dom::bindings::IntersectionObserver::Wrap(aCx, this, aGivenProto);
  }
