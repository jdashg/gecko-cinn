...
public:
  ...
  // inherit from it...
  static const auto ELEMENT_NODE = mozilla::dom::bindings::Node::ELEMENT_NODE;
  static const auto ATTRIBUTE_NODE = mozilla::dom::bindings::Node::ATTRIBUTE_NODE;
  static const auto TEXT_NODE = mozilla::dom::bindings::Node::TEXT_NODE;
  static const auto CDATA_SECTION_NODE =
    mozilla::dom::bindings::Node::CDATA_SECTION_NODE;
  static const auto ENTITY_REFERENCE_NODE =
    mozilla::dom::bindings::Node::ENTITY_REFERENCE_NODE;
  static const auto ENTITY_NODE = mozilla::dom::bindings::Node::ENTITY_NODE;
  static const auto PROCESSING_INSTRUCTION_NODE =
    mozilla::dom::bindings::Node::PROCESSING_INSTRUCTION_NODE;
  static const auto COMMENT_NODE = mozilla::dom::bindings::Node::COMMENT_NODE;
  static const auto DOCUMENT_NODE = mozilla::dom::bindings::Node::DOCUMENT_NODE;
  static const auto DOCUMENT_TYPE_NODE =
    mozilla::dom::bindings::Node::DOCUMENT_TYPE_NODE;
  static const auto DOCUMENT_FRAGMENT_NODE =
    mozilla::dom::bindings::Node::DOCUMENT_FRAGMENT_NODE;
  static const auto NOTATION_NODE = mozilla::dom::bindings::Node::NOTATION_NODE;
