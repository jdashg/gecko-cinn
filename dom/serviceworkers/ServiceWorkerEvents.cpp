...
{
  if (EventPhase() == bindings::Event::NONE || mWaitToRespond) {
...
{
  return mozilla::dom::bindings::PushMessageData::Wrap(aCx, this, aGivenProto);
}
...
{
  return mozilla::dom::bindings::PushEvent::Wrap(aCx, this, aGivenProto);
}
