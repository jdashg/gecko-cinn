...
dictionary WebGPUBindGroupBindingg {
...
dictionary WebGPUBindGroupLayoutDescriptor {
    sequence<WebGPUBindGroupBindingg> bindingTypes;
};
...
dictionary WebGPUBufferBindingg {
    WebGPUBuffer buffer;
    u32 offset;
    u32 size;
};
...
typedef (WebGPUSampler or WebGPUTextureView or WebGPUBufferBindingg) WebGPUBindingResource;

dictionary WebGPUBindingg {
...
dictionary WebGPUBindGroupDescriptor {
    ...
    sequence<WebGPUBindingg> bindings;
};
