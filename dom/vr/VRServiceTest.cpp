...
{
  return bindings::VRMockDisplay::Wrap(aCx, this, aGivenProto);
}
...
{
  return bindings::VRMockController::Wrap(aCx, this, aGivenProto);
}
...
{
  return bindings::VRServiceTest::Wrap(aCx, this, aGivenProto);
}
