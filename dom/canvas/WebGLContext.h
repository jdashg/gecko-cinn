...
private:
    void SetEnable(const char* funcName, GLenum cap, bool val);
public:
    void Disable(GLenum cap) { SetEnable("disable", cap, false); }
    void Enable (GLenum cap) { SetEnable("enable" , cap, true ); }
...
protected:
    ...
    mutable int mDrawCallsSinceLastFlush;
