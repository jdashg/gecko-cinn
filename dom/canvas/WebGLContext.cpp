...
{
    nsCString failureId;
    RefPtr<GLContext> gl = gl::GLContextProvider::CreateOffscreen(flags, &failureId);
    if (gl && gl->IsANGLE()) {
        gl = nullptr;
    }
...
bool
WebGLContext::CreateAndInitGLWith(const FnCreateGL_T fnCreateGL,
...
WebGLContext::SetDimensions(int32_t signedWidth, int32_t signedHeight)
{
    ...
    if (gl) {
        ...
        gl->ResetSyncCallCount("Existing WebGLContext resize.");
        return NS_OK;
    }
