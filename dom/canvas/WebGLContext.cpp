...
Maybe<layers::SurfaceDescriptor> WebGLContext::GetFrontBuffer(const layers::TextureType consumerType) {
  if (mSwapChain.mFactory && mSwapChain.mFactory->mDesc.consumerType != consumerType) {
