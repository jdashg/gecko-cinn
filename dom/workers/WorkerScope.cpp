                                             ...
                                             JS::MutableHandle<JSObject*> aReflector)
{
  ...
  return bindings::DedicatedWorkerGlobalScope::Wrap(aCx, this, this,
                                                 options,
                                                 GetWorkerPrincipal(),
                                                 true, aReflector);
}
                                          ...
                                          JS::MutableHandle<JSObject*> aReflector)
{
  ...
  return bindings::SharedWorkerGlobalScope::Wrap(aCx, this, this, options,
                                              GetWorkerPrincipal(),
                                              true, aReflector);
}
                                           ...
                                           JS::MutableHandle<JSObject*> aReflector)
{
  ...
  return bindings::ServiceWorkerGlobalScope::Wrap(aCx, this, this, options,
                                               GetWorkerPrincipal(),
                                               true, aReflector);
}
                                            ...
                                            JS::MutableHandle<JSObject*> aReflector)
{
  ...
  return bindings::WorkerDebuggerGlobalScope::Wrap(aCx, this, this, options,
