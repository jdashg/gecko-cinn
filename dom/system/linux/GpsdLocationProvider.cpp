  ...
  NS_IMETHOD Run() override
  {
    ...
    switch (GPSD_API_MAJOR_VERSION) {
      case 5:
        ...
        break;
      default:
        err = bindings::PositionError::POSITION_UNAVAILABLE;
        break;
    }
...
protected:
  int PollLoop5()
  {
    ...
    return err;
#else
    return bindings::PositionError::POSITION_UNAVAILABLE;
  ...
  static int ErrnoToError(int aErrno)
  {
    switch (aErrno) {
      ...
      case EPERM:
          MOZ_FALLTHROUGH;
      case EROFS:
        return bindings::PositionError::PERMISSION_DENIED;
      case ETIME:
          MOZ_FALLTHROUGH;
      case ETIMEDOUT:
        return bindings::PositionError::TIMEOUT;
      default:
        return bindings::PositionError::POSITION_UNAVAILABLE;
    }
  }
