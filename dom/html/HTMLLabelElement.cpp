...
{
  return bindings::HTMLLabelElement::Wrap(aCx, this, aGivenProto);
}
        ...
        if (mouseEvent->IsLeftClickEvent()) {
          ...
          if (mouseEvent->mClickCount <= 1) {
            ...
            if (fm) {
              ...
              bool byMouse = (mouseEvent->inputSource != bindings::MouseEvent::MOZ_SOURCE_KEYBOARD);
              bool byTouch = (mouseEvent->inputSource == bindings::MouseEvent::MOZ_SOURCE_TOUCH);
              fm->SetFocus(content,
                                   ...
                                   bool aIsTrustedEvent)
{
  if (!aKeyCausesActivation) {
    ...
    event.inputSource = bindings::MouseEvent::MOZ_SOURCE_KEYBOARD;
