                           ...
                           uint16_t* aResult)
{
  *aResult = FIND_NOTFOUND;
  ...
  int16_t rangeCompareResult =
    mStartPointRange->CompareBoundaryPoints(bindings::Range::START_TO_START,
      ...
      if ((!canSeeRange && !usesIndependentSelection) ||
        ...
        if (aFindPrev) {
          ...
          int16_t compareResult =
            mStartPointRange->CompareBoundaryPoints(bindings::Range::START_TO_END,
                                                    *returnRange, rv);
          ...
          IgnoredErrorResult rv;
          int16_t compareResult =
            mStartPointRange->CompareBoundaryPoints(bindings::Range::END_TO_START,
                                                    *returnRange, rv);
          if (!rv.Failed() && compareResult >= 0) {
