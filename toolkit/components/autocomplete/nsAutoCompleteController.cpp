  ...
  *_retval = false;
  ...
  if (newValue.Length() == 0) {
    ...
    if (popupClosedByCompositionStart && handlingCompositionCommit) {
      bool cancel;
      HandleKeyNavigation(dom::bindings::KeyboardEvent::DOM_VK_DOWN, &cancel);
      return NS_OK;
    }
    ClosePopup();
    return NS_OK;
...
nsAutoCompleteController::HandleKeyNavigation(uint32_t aKey, bool *_retval)
{
  ...
  *_retval = false;
  ...
  if (aKey == dom::bindings::KeyboardEvent::DOM_VK_UP ||
      aKey == dom::bindings::KeyboardEvent::DOM_VK_DOWN ||
      aKey == dom::bindings::KeyboardEvent::DOM_VK_PAGE_UP ||
      aKey == dom::bindings::KeyboardEvent::DOM_VK_PAGE_DOWN)
  {
    ...
    *_retval = true;
    ...
    input->GetPopupOpen(&isOpen);
    if (isOpen) {
      bool reverse = aKey == dom::bindings::KeyboardEvent::DOM_VK_UP ||
                      aKey == dom::bindings::KeyboardEvent::DOM_VK_PAGE_UP ? true : false;
      bool page = aKey == dom::bindings::KeyboardEvent::DOM_VK_PAGE_UP ||
                    aKey == dom::bindings::KeyboardEvent::DOM_VK_PAGE_DOWN ? true : false;
      ...
      else if (aKey == dom::bindings::KeyboardEvent::DOM_VK_DOWN) {
        nsAutoString text;
  ...
  } else if (   aKey == dom::bindings::KeyboardEvent::DOM_VK_LEFT
             || aKey == dom::bindings::KeyboardEvent::DOM_VK_RIGHT
#ifndef XP_MACOSX
             || aKey == dom::bindings::KeyboardEvent::DOM_VK_HOME
#endif
            )
  {
