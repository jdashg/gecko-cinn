...
nsFormFillController::KeyPress(Event* aEvent)
{
  ...
  switch (k) {
  case bindings::KeyboardEvent::DOM_VK_DELETE:
#ifndef XP_MACOSX
    mController->HandleDelete(&cancel);
    break;
  case bindings::KeyboardEvent::DOM_VK_BACK_SPACE:
  ...
  case bindings::KeyboardEvent::DOM_VK_RIGHT:
    {
      ...
      if (wm.IsVertical()) {
        switch (k) {
        case bindings::KeyboardEvent::DOM_VK_LEFT:
          k = wm.IsVerticalLR() ? bindings::KeyboardEvent::DOM_VK_UP
                                : bindings::KeyboardEvent::DOM_VK_DOWN;
          break;
        case bindings::KeyboardEvent::DOM_VK_RIGHT:
          k = wm.IsVerticalLR() ? bindings::KeyboardEvent::DOM_VK_DOWN
                                : bindings::KeyboardEvent::DOM_VK_UP;
          break;
        case bindings::KeyboardEvent::DOM_VK_UP:
          k = bindings::KeyboardEvent::DOM_VK_LEFT;
          break;
        case bindings::KeyboardEvent::DOM_VK_DOWN:
          k = bindings::KeyboardEvent::DOM_VK_RIGHT;
          break;
        }
      }
    }
  ...
  if (cancel) {
    ...
    if (k == bindings::KeyboardEvent::DOM_VK_RETURN) {
...
nsFormFillController::ShowPopup()
{
  ...
  if (value.Length() > 0) {
    ...
    bool cancel = false;
    mController->HandleKeyNavigation(bindings::KeyboardEvent::DOM_VK_DOWN, &cancel);
  }
