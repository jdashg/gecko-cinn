...
nsChildView::SendMayStartSwipe(const mozilla::PanGestureInput& aSwipeStartEvent)
{
  ...
  uint32_t direction = (aSwipeStartEvent.mPanDisplacement.x > 0.0)
    ? (uint32_t)dom::bindings::SimpleGestureEvent::DIRECTION_RIGHT
    : (uint32_t)dom::bindings::SimpleGestureEvent::DIRECTION_LEFT;
...
- (void)swipeWithEvent:(NSEvent *)anEvent
{
  ...
  if (deltaX > 0.0)
    geckoEvent.mDirection |= dom::bindings::SimpleGestureEvent::DIRECTION_LEFT;
  else if (deltaX < 0.0)
    geckoEvent.mDirection |= dom::bindings::SimpleGestureEvent::DIRECTION_RIGHT;

  // Record the up/down direction.
  if (deltaY > 0.0)
    geckoEvent.mDirection |= dom::bindings::SimpleGestureEvent::DIRECTION_UP;
  else if (deltaY < 0.0)
    geckoEvent.mDirection |= dom::bindings::SimpleGestureEvent::DIRECTION_DOWN;
...
- (void)rotateWithEvent:(NSEvent *)anEvent
{
  ...
  if (rotation > 0.0) {
    geckoEvent.mDirection =
      dom::bindings::SimpleGestureEvent::ROTATION_COUNTERCLOCKWISE;
  } else {
    geckoEvent.mDirection = dom::bindings::SimpleGestureEvent::ROTATION_CLOCKWISE;
  }
  ...
  case eGestureState_RotateGesture:
    {
      ...
      if (mCumulativeRotation > 0.0) {
        ...
        geckoEvent.mDirection =
          dom::bindings::SimpleGestureEvent::ROTATION_CLOCKWISE;
      }
                        ...
                        toGeckoEvent:(WidgetWheelEvent*)outWheelEvent
{
  ...
  outWheelEvent->mDeltaMode =
    usePreciseDeltas ? dom::bindings::WheelEvent::DOM_DELTA_PIXEL
                     : dom::bindings::WheelEvent::DOM_DELTA_LINE;
                           ...
                           toGeckoEvent:(WidgetMouseEvent*)aOutGeckoEvent
{
  ...
  aOutGeckoEvent->inputSource = dom::bindings::MouseEvent::MOZ_SOURCE_PEN;
