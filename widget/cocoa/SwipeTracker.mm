...
{
  return (mSwipeDirection == dom::bindings::SimpleGestureEvent::DIRECTION_RIGHT) ?
    -1.0 : 1.0;
}
...
SwipeTracker::ClampToAllowedRange(double aGestureAmount) const
{
  ...
  double min =
    (mSwipeDirection == dom::bindings::SimpleGestureEvent::DIRECTION_RIGHT) ?
      -1.0 : 0.0;
  double max =
    (mSwipeDirection == dom::bindings::SimpleGestureEvent::DIRECTION_LEFT) ?
      1.0 : 0.0;
