...
public:
                          ...
                          float aX, float aY, int buttons)
    {
        ...
        MouseInput input(mouseType, buttonType, bindings::MouseEvent::MOZ_SOURCE_MOUSE, ConvertButtons(buttons), origin, aTime, GetEventTimeStamp(aTime), GetModifiers(aMetaState));
