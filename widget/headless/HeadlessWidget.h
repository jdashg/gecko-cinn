...
#define MOZ_HEADLESS_SCROLL_DELTA_MODE mozilla::dom::bindings::WheelEvent::DOM_DELTA_LINE
#elif defined(XP_WIN)
...
#define MOZ_HEADLESS_SCROLL_DELTA_MODE mozilla::dom::bindings::WheelEvent::DOM_DELTA_PIXEL
