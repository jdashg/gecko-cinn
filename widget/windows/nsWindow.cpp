                                         ...
                                         LayoutDeviceIntPoint aEventPoint)
{
  ...
  if (aEventMessage == eMouseDown) {
    ...
    hittest.inputSource = bindings::MouseEvent::MOZ_SOURCE_TOUCH;
                             ...
                             WinPointerInfo* aPointerInfo)
{
  ...
  if (bindings::MouseEvent::MOZ_SOURCE_PEN == aInputSource
  ...
  *aRetValue = 0;
  ...
  switch (msg) {
    ...
    case MOZ_WM_PEN_LEAVES_HOVER_OF_DIGITIZER:
    {
      ...
      if (pointerId != 0) {
        ...
        DispatchMouseEvent(eMouseExitFromWidget, wParam, pos, false,
                           WidgetMouseEvent::eLeftButton,
                           bindings::MouseEvent::MOZ_SOURCE_PEN, &pointerInfo);
    ...
    case WM_CONTEXTMENU:
    {
      ...
      // need to do anything.
      if (mTouchWindow && MOUSE_INPUT_SOURCE() == bindings::MouseEvent::MOZ_SOURCE_TOUCH) {
...
bool nsWindow::OnGesture(WPARAM wParam, LPARAM lParam)
{
  ...
  if (mGesture.IsPanEvent(lParam)) {
    ...
    wheelEvent.inputSource = bindings::MouseEvent::MOZ_SOURCE_TOUCH;
  ...
  switch (nativeMessage) {
    ...
    case WM_NCMBUTTONDOWN:
      if (nativeMessage != WM_TOUCH &&
          ...
          MOUSE_INPUT_SOURCE() == bindings::MouseEvent::MOZ_SOURCE_TOUCH) {
