...
GCC_4_9 = GCC_V('4.9.3')
GXX_4_9 = GXX_V('4.9.3') + SUPPORTS_DRAFT_CXX14_VERSION
GCC_5 = GCC_V('5.2.1') + DEFAULT_C11
GXX_5 = GXX_V('5.2.1') + DEFAULT_CXX_14
GCC_6 = GCC_V('6.4.0') + DEFAULT_C11
GXX_6 = GXX_V('6.4.0') + DEFAULT_CXX_14
GCC_7 = GCC_V('7.3.0') + DEFAULT_C11
GXX_7 = GXX_V('7.3.0') + DEFAULT_CXX_14
...
class LinuxToolchainTest(BaseToolchainTest):
    PATHS = {
        '/usr/bin/gcc': GCC + GCC_PLATFORM_X86_64_LINUX,
        '/usr/bin/g++': GXX + GCC_PLATFORM_X86_64_LINUX,
    ...
    GCC_RESULT = GCC_6_RESULT + {'compiler': '/usr/bin/gcc'}
    GXX_RESULT = GXX_6_RESULT + {'compiler': '/usr/bin/g++'}
    ...
    def test_gcc(self):
        ...
        self.do_toolchain_test(self.PATHS, {
            'c_compiler': self.GCC_RESULT,
            'cxx_compiler': self.GXX_RESULT,
        })
    ...
    def test_mismatched_gcc(self):
        ...
        self.do_toolchain_test(self.PATHS, {
            'c_compiler': self.GCC_RESULT,
            'cxx_compiler': self.GXX_RESULT,
            'host_c_compiler': self.GCC_RESULT,
            'host_cxx_compiler': (
    ...
    def test_mixed_compilers(self):
        self.do_toolchain_test(self.PATHS, {
            ...
            'cxx_compiler': self.CLANGXX_3_6_RESULT,
            'host_c_compiler': self.GCC_RESULT,
            'host_cxx_compiler': self.GXX_RESULT,
        }, environ={
            'CC': 'clang',
            'HOST_CC': 'gcc',
        })
...
class LinuxSimpleCrossToolchainTest(BaseToolchainTest):
    ...
    GCC_RESULT = LinuxToolchainTest.GCC_RESULT
    GXX_RESULT = LinuxToolchainTest.GXX_RESULT
...
class LinuxX86_64CrossToolchainTest(BaseToolchainTest):
    ...
    PATHS = {
        '/usr/bin/gcc': GCC + GCC_PLATFORM_X86_LINUX,
        '/usr/bin/g++': GXX + GCC_PLATFORM_X86_LINUX,
...
class OSXToolchainTest(BaseToolchainTest):
    ...
    PATHS = {
        '/usr/bin/gcc': GCC + GCC_PLATFORM_X86_64_OSX,
        '/usr/bin/g++': GXX + GCC_PLATFORM_X86_64_OSX,
...
class WindowsToolchainTest(BaseToolchainTest):
    ...
    PATHS = {
        ...
        '/usr/bin/gcc': GCC + GCC_PLATFORM_X86_WIN,
        '/usr/bin/g++': GXX + GCC_PLATFORM_X86_WIN,
...
class Windows64ToolchainTest(WindowsToolchainTest):
    ...
    PATHS = {
        ...
        '/usr/bin/gcc': GCC + GCC_PLATFORM_X86_64_WIN,
        '/usr/bin/g++': GXX + GCC_PLATFORM_X86_64_WIN,
...
class LinuxCrossCompileToolchainTest(BaseToolchainTest):
    ...
    PATHS = {
        ...
        '/usr/bin/arm-linux-gnu-gcc': GCC + GCC_PLATFORM_ARM_LINUX,
        '/usr/bin/arm-linux-gnu-g++': GXX + GCC_PLATFORM_ARM_LINUX,
    ...
    ARM_GCC_RESULT = LinuxToolchainTest.GCC_RESULT + {
        'compiler': '/usr/bin/arm-linux-gnu-gcc',
    }
    ARM_GXX_RESULT = LinuxToolchainTest.GXX_RESULT + {
    ...
    def do_test_cross_gcc_32_64(self, host, target):
        ...
        self.TARGET = target
        paths = {
            '/usr/bin/gcc': GCC + self.PLATFORMS[host],
            '/usr/bin/g++': GXX + self.PLATFORMS[host],
        }
        cross_flags = {
            'flags': ['-m64' if '64' in target else '-m32']
        }
        self.do_toolchain_test(paths, {
            'c_compiler': self.GCC_RESULT + cross_flags,
            'cxx_compiler': self.GXX_RESULT + cross_flags,
            'host_c_compiler': self.GCC_RESULT,
            'host_cxx_compiler': self.GXX_RESULT,
        })
    ...
    def do_test_cross_gcc(self, host, target):
        ...
        paths.update({
            '%s-gcc' % toolchain_prefix: GCC + self.PLATFORMS[target],
            '%s-g++' % toolchain_prefix: GXX + self.PLATFORMS[target],
        })
        self.do_toolchain_test(paths, {
            'c_compiler': self.GCC_RESULT + {
    ...
    def test_cannot_cross(self):
        ...
        paths = {
            '/usr/bin/gcc': GCC + self.PLATFORMS['mips-unknown-linux-gnu'],
            '/usr/bin/g++': GXX + self.PLATFORMS['mips-unknown-linux-gnu'],
        }
        self.do_toolchain_test(paths, {
    ...
    def test_guess_cross_cxx(self):
        ...
        self.do_toolchain_test(self.PATHS, {
            'c_compiler': self.ARM_GCC_RESULT,
            'cxx_compiler': self.ARM_GXX_RESULT,
            'host_c_compiler': self.CLANG_3_6_RESULT,
            'host_cxx_compiler': self.CLANGXX_3_6_RESULT,
        }, environ={
...
class OpenBSDToolchainTest(BaseToolchainTest):
    ...
    PATHS = {
        '/usr/bin/gcc': GCC + GCC_PLATFORM_X86_64 + GCC_PLATFORM_OPENBSD,
        '/usr/bin/g++': GXX + GCC_PLATFORM_X86_64 + GCC_PLATFORM_OPENBSD,
    }
    GCC_RESULT = LinuxToolchainTest.GCC_RESULT
    GXX_RESULT = LinuxToolchainTest.GXX_RESULT
